  ...
  return <React.Fragment>
    ...
    <div style={chapterStyle}>
      <div style={contentStyle}>
        ...
        <Trans parent="p" style={paragraphStyle}>
          L'association $t(productName).org est là pour y voir plus clair, en proposant un
    ...
    <div style={chapterStyle}>
      <div style={contentStyle}>
        ...
        <Trans parent="p" style={paragraphStyle}>
          $t(productName).org vise à orienter vers les meilleurs services de l'emploi pour les
