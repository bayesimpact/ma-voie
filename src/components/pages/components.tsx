...
const ComponentsPage = (): React.ReactElement => {
  return <Layout header="Header title" title="Layout title" bigTitle="Layout big title">
    ...
    <br />
    <Button type="email" onClick={onClick}>Button Email</Button>
    <br />
    <Button type="facebook" onClick={onClick}>Button Facebook</Button>
    <br />
    <Button type="google" onClick={onClick}>Button Google</Button>
    <br />
    <Tip title="Astuce">
