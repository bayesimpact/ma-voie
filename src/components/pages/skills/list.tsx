...
import {useProject, useProjectDocRefConfig, useProjectId, useSkillsList} from 'store/selections'
...
const SkillsListPage = (): React.ReactElement => {
  ...
  const handleClick = useCallback((): void => {
    firestore.update(docRefConfig, {skills: valuesSelected})
  ...
  }, [firestore, history, projectId, skillsList, t, valuesSelected])
